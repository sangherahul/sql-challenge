...
SELECT  DepE.emp_no AS "Employee Number", emp.last_name AS "Last Name", emp.first_name AS "First Name", dept.dept_name AS "Department Name"
FROM dept_emp  DepE
JOIN departments dept
...
SELECT DepE.emp_no, emp.first_name, emp.last_name, dept.dept_name
FROM dept_emp DepE
JOIN employees emp
ON DepE.emp_no=emp.emp_no
JOIN departments dept
